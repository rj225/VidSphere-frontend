              ...
              {showDeleteModal && (
                <div className="fixed inset-0 backdrop-blur-sm bg-slate-500 bg-opacity-20 flex items-center justify-center">
                  <div className="bg-gray-800 p-4 rounded shadow-lg text-white">
                    <p className="md:text-xl text-sm">Are you sure you want to delete this playlist?</p>
                    <div className="flex justify-end mt-4">
                      <button
                        onClick={() => setShowDeleteModal(false)}
                        className="bg-gray-600 hover:bg-gray-700 text-white md:text-base text-xs py-1 px-3 rounded mr-2"
                      >
                        Cancel
                      </button>
                      <button
                        onClick={confirmDelete}
                        className="bg-red-500 hover:bg-red-600 text-xs md:text-base text-white py-1 px-3 rounded"
                      >
                        Delete
                      </button>
                    </div>
